        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    Fovea_X = (x_0 + x_1) / 2
                    Fovea_Y = (y_0 + y_1) / 2
                    #save_data = path.split('.')[0]
                    #print((Fovea_X, Fovea_Y))
                    #pre_array.append(Fovea_X, Fovea_Y)
            ...
            #save_data = path.split('.')[0]
            #print((Fovea_X, Fovea_Y))
            #pre_array.append((save_data, Fovea_X, Fovea_Y))
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'yolov5.pt', help='model path(s)')
